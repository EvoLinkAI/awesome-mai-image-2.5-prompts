...
curl --request POST \
  ...
  --data '{
    "model": "mai-image-2.5",
    "prompt": "A photorealistic editorial portrait with warm golden-hour light, preserved identity, natural skin texture, high-end magazine composition"
  }'
```
...
> [!NOTE]
> The author published the full reusable prompt in the image alt text. This is a concise domestic-scene prompt that mixes comfortcore subject matter with decopunk production design and soft morning light.
