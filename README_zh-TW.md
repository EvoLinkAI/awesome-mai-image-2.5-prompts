...
- **2026 年 6 月 16 日：** 新增 1 個來自 6 月 15 日 curation 視窗的人像與攝影案例——@stevegilham1 的 Decopunk Morning Coffee with Cat。
- **2026 年 6 月 15 日：** 新增 1 個來自 6 月 14 日 curation 視窗的 Poster & Illustration 案例——@stevegilham1 的 Moonlit Volkswagen Bus Landscape。
...
- **2026 年 6 月 14 日：** 新增 1 個來自最新 curation 批次的 Poster & Illustration 案例——@madonomori 的「サイバーパンク女騎士」。
- **2026年6月5日：** 新增 3 個精選案例——2 個 Poster & Illustration 案例，以及 1 個來自 6/4–6/5 curation batch 的 Comparison 案例。
...
> [!NOTE]
> 作者在圖片 alt 文字中公開了可直接重複使用的完整提示詞。這是一條簡潔的室內場景提示詞，把 comfortcore 題材、decopunk 美術設計與柔和晨光結合在一起，重現性很高。
...
> [!NOTE]
> 公開提示詞來自父推文中 @BeanieBlossom 的內容，而這則回覆展示的是 Steve Gilham 用 MAI-Image 跑出的結果。因為提示詞邊界清楚，而且 MAI 的成圖乾淨俐落，所以保留為一個很強的海報風格參考案例。
