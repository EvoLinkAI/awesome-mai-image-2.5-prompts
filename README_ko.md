...
- **2026년 6월 15일:** 6월 14일 curation 윈도우에서 Poster & Illustration 사례 1건 추가 — @stevegilham1의 Moonlit Volkswagen Bus Landscape.
...
- **2026년 6월 14일:** 최신 큐레이션 배치에서 Poster & Illustration 사례 1건 추가 — @madonomori의 サイバーパンク女騎士.
- **2026년 6월 5일:** 6월 4–5일 curation 배치에서 새 사례 3건을 추가했습니다 — Poster & Illustration 2건, Comparison 1건.
...
> [!NOTE]
> 공개된 프롬프트 원문은 부모 스레드의 @BeanieBlossom 게시물에 있고, 이 답글은 Steve Gilham이 그 프롬프트를 MAI-Image로 실행한 결과를 보여 줍니다. 프롬프트 경계가 명확하고 MAI 결과물도 포스터 스타일 참고 사례로 충분히 깔끔해서 이 케이스를 유지했습니다.
