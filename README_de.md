...
-- **10. Juni 2026:** 1 neues Portrait & Fotografie-Fallbeispiel hinzugefügt — Fabric-Maskottchen Pixel-Art-Porträt von der Microsoft Build (Kurations-Batch vom 9.–10. Juni).
...
- [📸 Porträt und Fotografie](#-porträt-und-fotografie)
  ...
  - [Case 8: Fabric Mascot Pixel Art Portrait (by @KeylaDoloresM)](#case-8-fabric-mascot-pixel-art-portrait-by-keyladoloresm)
...
### Case 8: [Fabric Mascot Pixel Art Portrait](https://x.com/KeylaDoloresM/status/2064555212224827509) (by [@KeylaDoloresM](https://x.com/KeylaDoloresM))

| Output |
| :----: |
| <img src="images/portrait_case8/output.jpg" width="400" alt="Fabric mascot reimagined as Peruvian Build staff in pixel art style with chullo hat and purple shirt, generated by MAI-Image-2.5"> |

**Prompt:**

```
the Fabric mascot as Peruvian Build staff — pixel art, chullo, purple staff shirt
```
