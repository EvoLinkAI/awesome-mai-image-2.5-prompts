...
- **16 juin 2026 :** Ajout d’un cas Portraits et photographie issu de la fenêtre de curation du 15 juin — Café du matin decopunk avec chat par @stevegilham1.
- **15 juin 2026 :** Ajout d’un cas Affiches et illustration issu de la fenêtre de curation du 14 juin — Paysage de Volkswagen Bus au clair de lune par @stevegilham1.
...
- **14 juin 2026 :** Ajout d’un cas Poster & Illustration issu du dernier lot de curation — サイバーパンク女騎士 par @madonomori.
- **5 juin 2026 :** 3 nouveaux cas sélectionnés ont été ajoutés — deux entrées Poster & Illustration et un nouvel exemple Comparison issus du lot de curation du 4 au 5 juin.
...
- [📸 Portraits et photographie](#-portraits-et-photographie)
  ...
  - [Case 8: Café du matin decopunk avec chat (by @stevegilham1)](#case-8-café-du-matin-decopunk-avec-chat-by-stevegilham1)
- [🎨 Affiches et illustration](#-affiches-et-illustration)
  ...
  - [Case 8: Paysage de Volkswagen Bus au clair de lune (by @stevegilham1)](#case-8-moonlit-volkswagen-bus-landscape-by-stevegilham1)
...
### Case 8: [Café du matin decopunk avec chat](https://x.com/stevegilham1/status/2066446362938662992) (by [@stevegilham1](https://x.com/stevegilham1))
...
> [!NOTE]
> L’auteur a publié le prompt réutilisable complet dans le texte alternatif de l’image. C’est un prompt de scène domestique concis qui mêle un sujet comfortcore à une direction artistique decopunk et à une lumière douce du matin.
...
### Case 8: [Paysage de Volkswagen Bus au clair de lune](https://x.com/stevegilham1/status/2066187534401479033) (by [@stevegilham1](https://x.com/stevegilham1))
...
> [!NOTE]
> Le prompt public se trouve dans le tweet parent de @BeanieBlossom, tandis que cette réponse montre l’exécution de ce prompt par Steve Gilham avec MAI-Image. Ce cas est conservé comme solide référence de style affiche, car les limites du prompt sont claires et le rendu MAI est visuellement propre.
